...
This motivated investigating \emph{inverse bifurcation analysis} methods that would use the cusp and limit points directly. Searching for bifurcating parameter regimes within a model is a difficult task. Whilst bespoke methods taking advantage of model structure and sampling-type methods existed, there was no end-to-end differentiable method that took advantage of bifurcation theory directly. We filled the gap in literature with the publication in Chapter \ref{chapter:inference}, and elucidated the importance of fitting the qualitative before any attempt at fitting the quantitative features within datasets.