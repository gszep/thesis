...
A phenotype is a qualitative state of an organism that can be described by several quantitative features. Before considering the additional complexity that comes with biology, let us first consider a simple mechanical metaphor: light bulbs. Light bulbs come in various combinations of quantitative features $\theta$ which could be shape, colour, materials and circuit design. The purpose of a light bulb is to fulfil a single function: beyond a certain threshold of voltage $p$ the brightness increases, pushing the qualitative state of the bulb from \emph{off} to \emph{on}.
