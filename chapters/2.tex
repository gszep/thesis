...
\begin{Figure}
	\begin{center}
	\includegraphics[scale=0.7]{pitchfork}
	\includegraphics[scale=0.7]{transcritical}
	\end{center}
...
\begin{Figure}
	\includegraphics[scale=0.7]{cyclic-fold}
	\includegraphics[scale=0.7]{infinite-period}
	\includegraphics[scale=0.7]{homoclinic}
