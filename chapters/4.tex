...
This chapter focuses on the problem of looking for parameter regimes for dynamical systems that result in bifurcations. This has been coined as \emph{inverse bifurcation analysis} \cite{Lu2006InverseSystems} and --- as motivated in Chapter \ref{chapter:introduction} --- becomes relevant to biomedical researchers in settings where the design goal of an organism is has a distinct phenotype.
...
\begin{itemize}
    ...
    \item \todo[inline]{Flow cytometry setup for detecting hopf bifurcation?}
\end{itemize}

\subsection{Contributions}

\textbf{Grisha Szep} prepared the manuscript, designed the cost function, derived mathematical results, wrote and released the Julia package under the supervision of \textbf{Neil Dalchau} and \textbf{Attila Czicasz-Nagy}.
