...
After gating live singlet cells and applying relevant compensation and auto-fluorescent normalisation, a figure similar to Supplementary Figure \ref{fig:double-exclusive:flow-hysteresis} can be produced to qualitatively assess if the cusp was sufficiently well sampled.
